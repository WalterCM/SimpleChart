...
const int SIMPLE_OPTION_SIZE = 50;                         // Size of the options
// Position of each option
const float SIMPLE_OPTION1_POS_X[] = {    WINDOW_HEIGHT * 5 / 16,
                                          WINDOW_HEIGHT * 6 / 16,
                                          WINDOW_HEIGHT * 7 / 16,
                                          WINDOW_HEIGHT * 8 / 16,
                                          WINDOW_HEIGHT * 9 / 16,
                                          ...
                                          WINDOW_HEIGHT * 11 / 16,
                                          WINDOW_HEIGHT * 13 / 16};
const float SIMPLE_OPTION_POS_Y = WINDOW_WIDTH * 7 / 8;
